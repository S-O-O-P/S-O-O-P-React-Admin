...
function Sidebar() {
  ...
  const routes = [
    ...
    { paths: ['/honeypot', '/honeypot/:no'], name: '허니팟 관리', activeImg: `${baseImagePath}icon_board_white.png`, inactiveImg: `${baseImagePath}icon_board_main_color.png` },
    ...
    { paths: ['/inquiry', '/inquiryanswer'], name: '1:1문의', activeImg: `${baseImagePath}icon_support_white.png`, inactiveImg: `${baseImagePath}icon_support_colored.png` }
  ];
